...
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE USE_IPV6 BOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN
...
macx:ICON = src/qt/res/icons/zedcoin.icns
macx:TARGET = "ZedCoin-Qt"
